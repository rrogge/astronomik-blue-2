---
title: "Astronomik Profi Blau Typ 2"
output:
  html_document:
    df_print: paged
---
...
```{r}
raw <- read.csv("astronomik-blue-2.csv")
...
```{r, echo}
ggplot(data) + 
  geom_line(aes(x=wavelength, y=transmission), color="blue") +
  coord_cartesian(xlim = c(200,900), ylim=c(0,100), expand=FALSE) +
  labs(x="Wavelength [nm]", y="Transmission [%]", title="Astronomik Profi Blau 2") +
  theme_bw()
```
